package droidicus.aquaregia.potion;
 ...
 * @author Choonster
 */
public class PotionAquaRegia extends Potion {
	/**
	 * The icon texture to use in the HUD and inventory GUI.
	 */
	private final ResourceLocation iconTexture;

	public PotionAquaRegia(boolean isBadEffect, int liquidColor, String name) {
		super(isBadEffect, liquidColor);
		setPotionName(this, name);
		iconTexture = new ResourceLocation(AquaRegia.MODID, "textures/potions/" + name + ".png");
	}

	public PotionAquaRegia(boolean isBadEffect, int liquidR, int liquidG, int liquidB, String name) {
