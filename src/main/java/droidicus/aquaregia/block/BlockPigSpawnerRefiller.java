 ...
 * @author Choonster
 */
public class BlockPigSpawnerRefiller extends BlockAquaRegia implements IPigSpawnerInteractable {
	...
	public boolean interact(IPigSpawner pigSpawner, World world, BlockPos pos, @Nullable ICommandSender iCommandSender) {
		if (pigSpawner instanceof IPigSpawnerFinite) {
			...
			if (iCommandSender != null) {
				iCommandSender.addChatMessage(new TextComponentTranslation("message.aquaregia:pig_spawner_refiller.refilled"));
			}
		}
