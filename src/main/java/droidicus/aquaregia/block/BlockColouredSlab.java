...
import droidicus.aquaregia.util.OreDictUtils;
 ...
 * @author Choonster
 */
public abstract class BlockColouredSlab extends BlockSlabAquaRegia<EnumDyeColor, BlockColouredSlab.EnumColourGroup, BlockColouredSlab> {
