package droidicus.aquaregia.client.cape;
...
class CapeUtils {
	private static final ResourceLocation CAPE_LOCATION = new ResourceLocation(AquaRegia.MODID, "textures/capes/aquaregia.png");
	...
	/**
	 * Queue the replacement of a player's cape with the AquaRegia cape.
	 * <p>
	...
	/**
	 * Replace a player's cape with the AquaRegia cape.
	 *
	 * @param player The player
	 */
	...
	/**
	 * Does the player have a AquaRegia cape?
	 * <p>
	 * Currently only returns true for me (Choonster)
	 *
	 * @param player The player
	 * @return True if the player has a AquaRegia cape
	 */
