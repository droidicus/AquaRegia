 ...
 * @author Choonster
 */
public class ItemDimensionReplacement extends ItemAquaRegia {
	/**
	...
	public void addInformation(ItemStack stack, EntityPlayer playerIn, List<String> tooltip, boolean advanced) {
		...
		if (replacement != null) {
			tooltip.add(I18n.format("item.aquaregia:dimension_replacement.replacement.desc", replacement.getDisplayName()));
		} else {
			tooltip.add(I18n.format("item.aquaregia:dimension_replacement.no_replacement.desc"));
		}
	}
}
