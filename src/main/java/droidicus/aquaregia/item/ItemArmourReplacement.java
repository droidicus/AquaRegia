...
import droidicus.aquaregia.util.InventoryUtils;
 ...
 * @author Choonster
 */
public class ItemArmourReplacement extends ItemArmourAquaRegia {
	// NBT keys
	...
	public void addInformation(final ItemStack stack, final EntityPlayer playerIn, final List<String> tooltip, final boolean advanced) {
		tooltip.add(I18n.format("item.aquaregia:armour_replacement.equip.desc"));
		tooltip.add(I18n.format("item.aquaregia:armour_replacement.unequip.desc"));
	}
}
