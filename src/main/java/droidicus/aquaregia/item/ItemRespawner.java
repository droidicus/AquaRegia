 ...
 * @author Choonster
 */
public class ItemRespawner extends ItemAquaRegia {
	...
	public ActionResult<ItemStack> onItemRightClick(ItemStack itemStackIn, World worldIn, EntityPlayer playerIn, EnumHand hand) {
		if (!worldIn.isRemote) {
			...
			if (bedLocation == null) {
				playerMP.addChatComponentMessage(new TextComponentTranslation("message.aquaregia:respawner.no_spawn_location"));
				return new ActionResult<>(EnumActionResult.FAIL, itemStackIn);
			}
			...
			playerIn.addChatComponentMessage(new TextComponentTranslation("message.aquaregia:respawner.teleporting", spawnLocation.getX(), spawnLocation.getY(), spawnLocation.getZ(), dimension));
