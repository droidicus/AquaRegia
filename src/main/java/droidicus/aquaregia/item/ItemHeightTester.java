 ...
 * @author Choonster
 */
public class ItemHeightTester extends ItemAquaRegia {
	...
	public ActionResult<ItemStack> onItemRightClick(ItemStack itemStackIn, World worldIn, EntityPlayer playerIn, EnumHand hand) {
		if (!worldIn.isRemote) {
			...
			if (playerIn.isSneaking()) {
				...
				playerIn.addChatComponentMessage(new TextComponentTranslation("message.aquaregia:height_tester.generate", chunk.xPosition, chunk.zPosition, pos.getX(), pos.getY(), pos.getZ()));
			} else {
				playerIn.addChatComponentMessage(new TextComponentTranslation("message.aquaregia:height_tester.height", pos.getX(), pos.getZ(), worldIn.getHeight(pos).getY()));
			}
		}
