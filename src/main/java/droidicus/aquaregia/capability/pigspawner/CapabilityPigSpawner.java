...
import droidicus.aquaregia.api.capability.pigspawner.IPigSpawnerInteractable;
import droidicus.aquaregia.capability.SimpleCapabilityProvider;
import droidicus.aquaregia.network.MessageUpdateHeldPigSpawnerFinite;
import droidicus.aquaregia.util.CapabilityUtils;
import droidicus.aquaregia.util.DebugUtil;
...
public final class CapabilityPigSpawner {
	 ...
	 */
	public static final ResourceLocation ID = new ResourceLocation(AquaRegia.MODID, "PigPower");
	...
	public static class EventHandler {
		...
		private void sendToPlayer(IPigSpawner pigSpawner, EntityPlayerMP player, EnumHand hand) {
			if (pigSpawner instanceof IPigSpawnerFinite) {
				...
				AquaRegia.network.sendTo(new MessageUpdateHeldPigSpawnerFinite(pigSpawnerFinite, hand), player);
			}
		}
