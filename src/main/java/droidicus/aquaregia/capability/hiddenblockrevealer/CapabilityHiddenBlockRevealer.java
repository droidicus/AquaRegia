...
import droidicus.aquaregia.network.MessageUpdateHeldHiddenBlockRevealer;
...
public class CapabilityHiddenBlockRevealer {
	 ...
	 */
	private static final ResourceLocation ID = new ResourceLocation(AquaRegia.MODID, "hidden_block_revealer");
	...
	private static void sendToPlayer(IHiddenBlockRevealer hiddenBlockRevealer, EntityPlayerMP player, EnumHand hand) {
		AquaRegia.network.sendTo(new MessageUpdateHeldHiddenBlockRevealer(hiddenBlockRevealer, hand), player);
	}
	...
	public static class RevealHiddenBlocksGetter {
		 ...
		 */
		private static final ResourceLocation ID = new ResourceLocation(AquaRegia.MODID, "reveal_hidden_blocks");
