...
import droidicus.aquaregia.api.capability.lastusetime.ILastUseTime;
import droidicus.aquaregia.capability.SimpleCapabilityProvider;
import droidicus.aquaregia.item.IItemPropertyGetterFix;
import droidicus.aquaregia.network.MessageUpdateHeldLastUseTime;
import droidicus.aquaregia.util.CapabilityUtils;
...
public class CapabilityLastUseTime {
	 ...
	 */
	public static final ResourceLocation ID = new ResourceLocation(AquaRegia.MODID, "LastUseTime");
	...
	private static void sendToPlayer(ILastUseTime lastUseTime, EntityPlayerMP player, EnumHand hand) {
		AquaRegia.network.sendTo(new MessageUpdateHeldLastUseTime(lastUseTime, hand), player);
	}
	...
	public static class TicksSinceLastUseGetter {
		 ...
		 */
		private static final ResourceLocation ID = new ResourceLocation(AquaRegia.MODID, "ticksSinceLastUse");
