...
import droidicus.aquaregia.inventory.IContainerCallbacks;
import droidicus.aquaregia.inventory.container.ContainerModChest;
import droidicus.aquaregia.inventory.itemhandler.IItemHandlerNameable;
import droidicus.aquaregia.inventory.itemhandler.ItemHandlerLoot;
import droidicus.aquaregia.inventory.itemhandler.wrapper.NameableCombinedInvWrapper;
...
public class TileEntityModChest extends TileEntityItemHandlerLoot implements IContainerCallbacks {
	 ...
	 */
	private static final ITextComponent DEFAULT_NAME = new TextComponentTranslation("container.aquaregia:chest");
