...
import droidicus.aquaregia.world.biome.BiomeDesertTest;
...
//	public static final BiomeDesertTest DESERT_TEST;
	...
	static {
//		DESERT_TEST = registerBiome(new BiomeDesertTest(new Biome.BiomeProperties("AquaRegia Desert Test")
//				.setBaseHeight(0.125F)
//				.setHeightVariation(0.05F)
//				.setTemperature(2.0F)
//				.setRainfall(0.0F)
//				.setRainDisabled()
//		), new ResourceLocation(AquaRegia.MODID, "desert_test"), BiomeManager.BiomeType.DESERT, 1000, HOT, DRY, SANDY, JUNGLE, SWAMP);
	}
