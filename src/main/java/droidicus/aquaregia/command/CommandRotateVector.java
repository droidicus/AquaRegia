...
import droidicus.aquaregia.util.VectorUtils;
...
public class CommandRotateVector extends CommandBase {
	...
	public String getCommandUsage(ICommandSender sender) {
		return "commands.aquaregia.rotatevector.usage";
	}
	...
	public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
		if (args.length < 5) throw new WrongUsageException("commands.aquaregia.rotatevector.usage");
		...
		if (axis == null) throw new WrongUsageException("commands.aquaregia.rotatevector.invalid_axis");
		...
		sender.addChatMessage(new TextComponentTranslation("commands.aquaregia.rotatevector.result", inputVector.getX(), inputVector.getY(), inputVector.getZ()));
	}
}
