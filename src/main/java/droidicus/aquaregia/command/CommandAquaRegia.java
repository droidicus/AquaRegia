...
import droidicus.aquaregia.init.ModCommands;
 ...
 * @author Choonster
 */
public class CommandAquaRegia extends CommandBase {
	/**
	...
	public CommandAquaRegia(MinecraftServer server) {
	...
	public String getCommandUsage(ICommandSender sender) {
		return "commands.aquaregia.usage";
	}
